...
public class PlaybackFragment extends DialogFragment {
    ...
    public PlaybackFragment newInstance(String pathStr, String songName) {
        PlaybackFragment f = new PlaybackFragment();


        Bundle b = new Bundle();
        b.putString("String_path", pathStr);
        b.putString("String_name", songName);
        f.setArguments(b);
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        pathToItem = getArguments().getString("String_path");
    ...
    private void startPlaying() {
        ...
        try {
            mMediaPlayer.setDataSource(pathToItem);
